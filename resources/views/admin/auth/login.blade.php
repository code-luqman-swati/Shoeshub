                                            ...
                                            <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                                ...
                                                <div class="relative">
                                                    <input
                                                        ...
                                                        required
                                                        autofocus
                                                        class="dark:bg-dark-900 h-11 w-full rounded-lg border px-4 py-2.5 text-sm shadow-theme-xs placeholder:text-gray-400 focus:outline-hidden focus:ring-3
                                                        @error('email')
...
<div>
    ...
    <div x-data="{ showPassword: false }" class="relative">
        <input
            ...
            required
            class="dark:bg-dark-900 h-11 w-full rounded-lg border px-4 py-2.5 pr-11 text-sm shadow-theme-xs placeholder:text-gray-400 focus:outline-hidden focus:ring-3
            @error('password')
                border-error-500 focus:border-error-300 focus:ring-error-500/20
            @else
                border-gray-300 focus:border-brand-300 focus:ring-brand-500/20 dark:border-gray-700
    ...
    <a
        href="/reset-password"
        class="text-sm font-medium text-brand-500 transition-colors hover:text-brand-600 dark:text-brand-400">
        Forgot password?
    </a>
</div>
                                    <!-- Button -->
                                    <div>
                                        <button
                                            class="bg-brand-500 shadow-theme-xs hover:bg-brand-600 flex w-full items-center justify-center rounded-lg px-4 py-3 text-sm font-medium text-white transition" type="submit"  >
                                            Sign In
                                        </button>
                                    </div>
                                </div>
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        ...
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Welcome to ShoeHub Admin Panel, please login to your account and manage your dashboard.
                        </p>
                    </div>
                </div>
            </div>
